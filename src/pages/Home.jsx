...
export default function Home() {
  ...
  return (
    <div className="flex flex-col">
      {/* ── 1. Hero Section ── */}
      <section className="relative min-h-[92vh] flex items-center justify-center pt-32 sm:pt-36 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden bg-gradient-to-b from-[#0D1F30] via-[#11273C] to-[#1A3651]">
        ...
        <div className="relative max-w-5xl mx-auto text-center flex flex-col items-center gap-6 sm:gap-8">
          ...
          {/* Headline */}
          <h1 className="text-4xl sm:text-6xl md:text-7xl font-black font-heading tracking-tight text-white leading-[1.08]">
            Where Trades Meet <span className="text-amber">Excellence.</span>
          </h1>

          {/* Subheadline with enhanced font size and readability */}
          <p className="text-base sm:text-xl md:text-2xl text-gray-light leading-relaxed max-w-3xl font-normal">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 w-full justify-center pt-3">
            <Link
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-8 py-4 rounded-lg bg-amber text-[#0D1F30] font-extrabold text-sm sm:text-base uppercase tracking-wider hover:bg-amber-hover hover:scale-[1.02] active:scale-[0.98] transition-all shadow-xl shadow-amber/25 focus:outline-none focus-visible:ring-2 focus-visible:ring-amber"
            >
            ...
            <Link
              to="/services"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-8 py-4 rounded-lg border-2 border-white/25 text-white font-bold text-sm sm:text-base uppercase tracking-wider hover:bg-white/10 hover:border-white/50 transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-amber"
            >
          ...
          {/* Trust Strip */}
          <div className="pt-8 border-t border-white/10 w-full flex flex-wrap items-center justify-center gap-6 sm:gap-10 text-xs sm:text-sm text-gray-light">
      ...
      <section className="bg-amber text-[#0D1F30] py-9 px-4 sm:px-6 lg:px-8 border-y-2 border-amber-dark shadow-inner">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-5 relative z-20">
        <div className="bg-[#0D1F30] border-2 border-amber/40 rounded-2xl p-6 shadow-2xl flex flex-col md:flex-row items-center justify-between gap-5">
          <div className="flex items-center gap-4 text-left">
            <div className="w-14 h-14 rounded-2xl bg-amber/20 text-amber flex items-center justify-center shrink-0">
              <AlertTriangle className="w-7 h-7 animate-pulse" />
            </div>
            <div>
              <span className="text-xs sm:text-sm font-extrabold uppercase tracking-widest text-[#FBBF24] block">
          ...
          <div className="flex items-center gap-3 shrink-0 w-full md:w-auto">
            <a
              ...
              className="w-full md:w-auto inline-flex items-center justify-center gap-2.5 px-7 py-3.5 rounded-lg bg-amber text-[#0D1F30] font-extrabold text-sm uppercase tracking-wider hover:bg-amber-hover transition-all shadow-md shadow-amber/20 focus:outline-none focus-visible:ring-2 focus-visible:ring-amber"
            >
      ...
      <section className="py-20 sm:py-28 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {services.map((service, index) => {
            ...
            return (
              <div
                key={service.id}
                className="bg-[#0D1F30] border border-white/10 hover:border-amber/60 rounded-2xl p-6 sm:p-7 shadow-xl hover:shadow-2xl hover:shadow-amber/10 transition-all duration-300 flex flex-col justify-between group"
              >
                <div>
        ...
        <div className="text-center mt-12">
          <Link
            to="/services"
            className="inline-flex items-center gap-2 px-8 py-4 rounded-lg border-2 border-white/25 hover:border-amber text-white hover:text-amber text-xs sm:text-sm font-bold uppercase tracking-wider transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-amber"
          >
      ...
      <section className="py-20 sm:py-28 bg-[#0D1F30] border-y border-white/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {differentiators.map((item, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="p-7 sm:p-8 rounded-2xl bg-white/[0.03] border border-white/10 hover:border-amber/40 transition-all flex flex-col gap-4 shadow-lg"
                >
      ...
      <section className="py-20 sm:py-28 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-[#0D1F30] border-2 border-white/15 rounded-3xl p-8 sm:p-12 shadow-2xl flex flex-col lg:flex-row items-center justify-between gap-8">
